...
# As a result / Consequently (Menekankan Hasil Akhir)
Contoh: "He changed the file permissions. As a result, the system blocked the access." (Dia mengubah izin akses file. Sebagai akibatnya/sehingga, sistem memblokir akses tersebut).

Frasa ini digunakan jika Anda ingin benar-benar menekankan bahwa dampak tersebut adalah hasil langsung dari kejadian sebelumnya.

Frasa apa ingin digunakan jika ingin benar-benar menekankan bahwa dampak tersebut adalah hasil langsung dari kejadian sebelumnya.


singular (myself, yourself, himself, herself, itself)
(self-esteem, self-control)
> buatkan diagram visual kecil yang sistem hubungan “self” → myself / yourself / himself / themselves, sehingga lebih mudah diingat. Ini biasanya bikin belajar reflexive pronoun jadi super jelas.
